...
ga('create', 'UA-31428430-4', 'typer.com.au');
ga('send', 'pageview');
...
new J(e,f);i.Ya("value",d);var h={path:f,update:a,C:b,status:l,ed:Hb(),nc:h,kd:0,kc:function(){i.vb("value",d)},lc:l},m=h.update(U(e.gb,f).V());if(u(m)){za("transaction failed: Data returned ",m);h.status=1;var n=L(e.fb,f),p=n.k()||[];p.push(h);M(n,p);p="object"===typeof m&&m!==l&&D(m,".priority")?m[".priority"]:U(e.g.I,f).j();n=$d(e);m=S(m,p);m=Wd(m,n);V(e.gb,f,m);h.nc&&(V(e.g.la,f,m),Qd(e.H,f,[f]));ee(e)}else h.kc(),h.C&&(e=he(e,f),h.C(l,o,e))};J.prototype.transaction=J.prototype.transaction;
...
//		$(userText).appendTo($('.top'));
        ...
        // mu new custom
		this.$genBtn = userInput.$genBtn = $('#genBtn');
        this.setupAuto()
    ...
    // auto grab text
    userInputView.setupAuto = function() {
        this.$genBtn.click(function(e) {
            console.log('auto filling text...')
